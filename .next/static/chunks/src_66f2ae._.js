        ...
        "Users.useEffect": ()=>{
            const fetchUsers = {
                "Users.useEffect.fetchUsers": async ()=>{
                    try {
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('http://localhost:8080/users/getusers');
...
_s(Users, "vvG5G9m+JVa2SSWAm277lQVAKio=");
_c = Users;
